...
class MinimaxAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        return max_action # final action is returned.
...
def betterEvaluationFunction(currentGameState):
    ...
    food_list = (currentGameState.getFood()).asList() # get all food as list
    capsule_list = currentGameState.getCapsules() #get all capsules
